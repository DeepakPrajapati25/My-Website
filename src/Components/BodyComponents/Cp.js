...
export default function Cp(props) {
    return (
        <div ref={props.cpRef} className="flex flex-col gap-10 pb-8 sm:pb-16 md:pb-24 lg:pb-32">
            ...
            <div>
                I give competitive programming contests in my free time. I'm a <span className="text-color-hover">Expert</span> on Codeforces, <span className="text-color-hover">4 star rated coder</span> on CodeChef and <span className="text-color-hover">Green</span> on Atcoder.
            </div>
